...
audience: partner
user-guide-title: Adobe Exchange - Guías de integración
user-guide-description: Guías de integración de Adobe Exchange
...
+ Ingesta de datos y acceso a perfiles {#profile-ingestion}
   ...
   + [Importar datos en tiempo real](profile-ingestion/real-time-import.md)
   + [Acceso al perfil unificado](profile-ingestion/query-profile.md)
